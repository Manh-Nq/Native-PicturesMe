...
class M002PicturesFrg : BaseFragment() {
    val TAG = M002PicturesFrg::class.java.name
    ...
    override fun initViews() {
        ...
        var photoItem: PhotoItem = getStorage().photoItem
        GlobalScope.launch(Dispatchers.Main) {
            Glide.with(mContext).load(photoItem.picture.raw).into(ivImage)
